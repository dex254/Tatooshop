                ...
                <form class="custom-validation" action="post">
                    ...
                    <div class="mb-0">
                        <div>
                            ...
                            <a href="<?php echo base_url('index.php/agents/');?>"> <button type="button" class="btn btn-outline-dark waves-effect waves-light"><i class="dripicons-view-list"></i>go to table</button></a>
                        </div>
                    </div>
                </form>
                <!-- end form -->
